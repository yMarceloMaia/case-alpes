  ...
  return (
    <header className={`relative z-50`}>

      {
        ...
        <section className={`fixed top-0 left-0 w-full bg-white shadow-md transition-all duration-300 min-[600px]:h-[60px] flex flex-col min-[600px]:flex-row min-[600px]:justify-between items-center`}>
          <div className="flex justify-between w-full h-[60px] items-center">
            <p className="min-[600px]:hidden flex justify-center items-center cursor-pointer text-[#666666] w-[165px]  gap-1">
